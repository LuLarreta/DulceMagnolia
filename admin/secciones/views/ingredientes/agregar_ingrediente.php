<div class="container bg-light shadow p-4 ">
    <div class="contaier-fluid">
        <h1 class="d-flex justify-content-center p-3">Agregar Ingrediente</h1>
        <div class=" bg-texto p-3">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-12 col-lg-8">
                        <form action="accion/ingredientes/agregar_ingrediente_acc.php" method="POST" enctype="multipart/form-data">
                            <div class="p-2">
